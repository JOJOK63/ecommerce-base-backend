...
('Console PlayStation 5', 'Console de jeux vidéo de nouvelle génération de Sony.', 499.99, 25, 4.5, 'AVAILABLE', NOW(), NOW()),
('Écouteurs AirPods', 'Écouteurs sans fil avec son haute qualité et réduction de bruit.', 129.99, 60, 0.05, 'AVAILABLE', NOW(), NOW()),
('Liseuse Kindle', 'Liseuse électronique légère pour lire partout.', 119.99, 35, 0.2, 'AVAILABLE', NOW(), NOW()),
('Appareil Photo Canon EOS', 'Appareil photo reflex numérique pour les photographes amateurs et professionnels.', 899.99, 12, 1.0, 'AVAILABLE', NOW(), NOW());
